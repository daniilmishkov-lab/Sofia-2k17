const stations = {
    ...
    rosathing: {
        ...
        type: "text",
        question:
        "/ВСТАВИТЬ СЮДА КУСОК КАРТЫ КУДА ИДТИ/ Принеси этому персонажу его любимый напиток, родом из главного города Верхней Франконии. Персонаж ожидает вас на метке 5b и получив эликсир выдаст вам предмет.",
        image: "img/danja.jpg",
        answer:
        "420",
